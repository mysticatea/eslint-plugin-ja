 ...
 * @author Ilya Volodin
 *
 * これは https://github.com/eslint/eslint/blob/bb213dccfd0661fb82e8de42cbaa996c97722929/lib/testers/rule-tester.js からコピーされ、
 * 翻訳テキストのためのチェックが追加されています。
 */
"use strict"
...
const ajv = require("eslint/lib/util/ajv")
...
const interpolate = require("eslint/lib/util/interpolate")
 ...
 * @this {Mocha}
 * @param {string} _text - The description of the test case.
 * @param {function} method - The logic of the test case.
 * @returns {any} Returned value of `method`.
 */
function itDefaultHandler(_text, method) {
    try {
 ...
 * @returns {any} Returned value of `method`.
 */
function describeDefaultHandler(_text, method) {
    return method.apply(this)
}
...
class RuleTester {
    ...
    run(ruleName, rule, test) {
        ...
        for (const scenarioType of requiredScenarios) {
                        ...
                        if (error.messageId) {
                            ...
                            if (typeof expectedMessage === "string") {
                                assert(
                                    ...
                                    `翻訳メッセージに変数表記が残っています: ${JSON.stringify(expectedMessage)}`
                                )
                            }
                        }
